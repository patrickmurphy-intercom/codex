...
pub enum Op {
    ...
    OverrideTurnContext {
        ...
        /// Updated OpenAI service tier preference.
        ///
        /// Use `Some(Some(_))` to set a specific tier, `Some(None)` to clear
        /// the tier override, or `None` to leave the existing value unchanged.
        #[serde(skip_serializing_if = "Option::is_none")]
